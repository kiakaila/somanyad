...
_.extend(conf, {
  ...
  sessionSecret: process.env.SESSION_SECRET || 'Ydflsfl',
});
...
_.extend(conf, {
  ...
  // },
  facebook: {
    clientID: process.env.FACEBOOK_ID || '1490957891206905',
    clientSecret: process.env.FACEBOOK_SECRET || 'afaef263cc19f6471e5e9ca96f9247ec',
    callbackURL: '/auth/facebook/callback',
    passReqToCallback: true
  },

  instagram: {
    clientID: process.env.INSTAGRAM_ID || '357b36b9dc8c4be285b55cc4468dd03e',
    clientSecret: process.env.INSTAGRAM_SECRET || 'e4c57cf1bd9240c29b2e8c286ad5378a',
    callbackURL: '/auth/instagram/callback',
    passReqToCallback: true
  },

  github: {
    clientID: process.env.GITHUB_ID || 'd6b217aa1441df9001ec',
    clientSecret: process.env.GITHUB_SECRET || '3857b4353e6e61ccae6a416180f765a584161ec5',
  ...
  google: {
    clientID: process.env.GOOGLE_ID || '1095397028260-lo7shggahq3d25dpi3dg9cgatmnbj7h9.apps.googleusercontent.com',
    clientSecret: process.env.GOOGLE_SECRET || 'of5SN4pnak3-nRAOK1sThegH',
...
var alipay_config = {
  partner:'2088102062322622' //合作身份者id，以2088开头的16位纯数字
  ...
  ,create_partner_trade_by_buyer_return_url: 'http://somanyad.com/members/aplipay/create_partner_trade_by_buyer/return_url'
};

var Alipay = require('alipay').Alipay;
var alipay = new Alipay(alipay_config);
_.extend(conf, {
  alipay: alipay
})
